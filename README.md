...
### 20주차 / 2015-09-18 / 2명
* 장소 예약 : 보름달님
* Arduino 소리 데이터를 이용한 전구 On/Off(DFE0034 센서 이용)

### 19주차 / 2015-09-11 / 2명

* 장소 예약 : 보름달님
* Arduino Wi-Fi 실습
* LED Operation 관련 내용 공유
   - https://iamrootiot1stscen.slack.com/files/hyunyi/F0AG69X2B/ws2801-test-rainbow-1.ino
   - 12v5a, http://mobile.auction.co.kr/Item/ViewItem.aspx?Itemno=A776935318 
